...
open class MockJiraClient(private val setup: IssueTrackingApplication) :
  IssueTrackingClient<Issue> {
  ...
  override fun createOrUpdateTargetIssue(
    ...
    val targetIssue =
      Issue("MK-" + (abs(Random.nextInt()) % 10000).toString(), "JIRA", LocalDateTime.now())
  ...
  override fun getComments(internalIssue: Issue): List<Comment> {
    return listOf(
      ...
      Comment(
        ...
        "Mary, could this be related to BUG-1234?",
        "2345"
      )
    )
  }
