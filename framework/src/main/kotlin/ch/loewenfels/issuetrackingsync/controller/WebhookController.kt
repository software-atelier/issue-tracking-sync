...
class WebhookController(
  ...
  fun triggerSyncRequest(
    @PathVariable sourceSystem: TrackingApplicationName,
  ...
  private fun loadAndQueueIssue(
    body: JsonNode,
    trackingApplication: IssueTrackingApplication
  ): String {
  ...
  private fun retrieveIssue(body: JsonNode, trackingApplication: IssueTrackingApplication): Issue =
    clientFactory.getClient(trackingApplication)
      .use { client -> client.getIssueFromWebhookBody(body) }
