...
object FieldSkippingEvaluatorFactory : Logging {
  private val evaluators: MutableMap<FieldMappingDefinition, MutableList<FieldSkippingEvaluator>> =
    mutableMapOf()
  ...
  private fun createFieldSkippingEvaluator(fieldSkippingEvaluatorDefinition: FieldSkippingEvaluatorDefinition): FieldSkippingEvaluator? {
    ...
    try {
      clazz =
        Class.forName(fieldSkippingEvaluatorDefinition.classname) as Class<FieldSkippingEvaluator>
    } catch (e: Exception) {
